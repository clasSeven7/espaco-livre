...
When(
  'ele preenche seus dados pessoais (nome, e-mail, telefone) e as informações sobre os espaços que disponibiliza (tipo de ambiente, localização, capacidade, etc.)',
  function () {
...
Then(
  'ele deve conseguir acessar a área de gerenciamento de reservas de espaços',
  function () {
